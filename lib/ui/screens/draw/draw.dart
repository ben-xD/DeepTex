...
class _DrawScreenState extends State {
  ...
  Widget build(BuildContext context) {
    ...
    void predictCharacterFromImage() async {
      ...
      img.Image resizedImage =
          img.copyResize(await getDrawnImage(), width: 32, height: 32);
    ...
    List<Stroke> strokes = InheritedStrokesHistory.of(context).strokes;
      ...
      appBar: AppBar(
        ...
        actions: <Widget>[
          ...
          IconButton(
            ...
            onPressed: () {
              InheritedStrokesHistory.of(context).resetStrokes();
            },
          ),
        ],
      ),
          ...
          children: <Widget>[
            GestureDetector(
              ...
              onPanEnd: (DragEndDetails details) {
                ...
                debouncedRecognition = Timer(
                    Duration(milliseconds: 500), predictCharacterFromImage);
            ...
            Row(
              children: <Widget>[
                IconButton(
                  ...
                  onPressed: () async {
                    saveImageHandler(await getDrawnImage());
                  },
                ),
                if (_busy)
